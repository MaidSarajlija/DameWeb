...
//			String ab=sc.getRealPath("/Index.jsp");
//			System.out.println("hier---------------------->"+ab);
			
			if(SpielerLadenWeb.getGameLaden()!=null){
				pdf.speichern(pfad+"/Desktop/"+ namefile, SpielerLadenWeb.getGameLaden());
			}else{
				pdf.speichern(pfad+"/Desktop/"+ namefile, Index.getGame());
			}
