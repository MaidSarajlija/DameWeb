...
public class SpeichernSER extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Index.getGame()!=null || SpielerLadenWeb.getGameLaden()!=null){
			
			if(SpielerLadenWeb.getGameLaden()!=null){
				ser.speichern(pfad+"/Desktop/"+ namefile, SpielerLadenWeb.getGameLaden());
			}else{
				ser.speichern(pfad+"/Desktop/"+ namefile, Index.getGame());
			}
